...
class ItemsController: UITableViewController, createCheckControllerDelegate, createLineItemControllerDelegate {
   ...
   // var employees = [Employee]()
    ...
    func getSummaryValues() {
        ...
        print("pymtCheckTotal = ", Double(file?.pymtCheckTotal ?? "") ?? nil)
...
//    private func setupUI() {
//        let header = UIView(frame: CGRect(x: 0, y: 0, width: view.frame.size.width, height: 343))
//
//
...
//        summaryButton.rightAnchor.constraint(equalTo: header.rightAnchor, constant: -16).isActive = true
//        summaryButton.topAnchor.constraint(equalTo: headerView.topAnchor, constant: 0).isActive = true
//        summaryButton.heightAnchor.constraint(equalToConstant: 34).isActive = true
//        summaryButton.widthAnchor.constraint(equalToConstant: 175).isActive = true
//
//        if file?.cocSwitch == true {
...
//        line.rightAnchor.constraint(equalTo:header.rightAnchor, constant: -16).isActive = true
//        line.topAnchor.constraint(equalTo: outOfPocketLabel.bottomAnchor, constant: 10).isActive = true
//        line.heightAnchor.constraint(equalToConstant: 1).isActive = true
//        line.leftAnchor.constraint(equalTo: headerView.leftAnchor, constant: 16).isActive = true
//
//        header.addSubview(noteLabel)
//        noteLabel.leftAnchor.constraint(equalTo: headerView.leftAnchor, constant: 16).isActive = true
//        noteLabel.topAnchor.constraint(equalTo: line.bottomAnchor).isActive = true
//        noteLabel.heightAnchor.constraint(equalToConstant: 35).isActive = true
//
//        header.addSubview(noteLabelInfo)
//        noteLabelInfo.leftAnchor.constraint(equalTo: headerView.leftAnchor, constant: 16).isActive = true
//        noteLabelInfo.rightAnchor.constraint(equalTo: header.rightAnchor, constant: -16).isActive = true
//        noteLabelInfo.topAnchor.constraint(equalTo: noteLabel.bottomAnchor).isActive = true
//        //noteLabelInfo.heightAnchor.constraint(equalToConstant: 70).isActive = true
//
//
//
//
