...
class CreateLineItemController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    var types = ["","ACV owed to HO","RCV work to do", "Cash work to do", "Credit"]
    ...
    private func setupUI() {
        ...
        typeLabel.topAnchor.constraint(equalTo: itemLineNumberTextField.bottomAnchor, constant: 20).isActive = true
        ...
        notesLabel.topAnchor.constraint(equalTo: typeTextField.bottomAnchor, constant: 20).isActive = true
