...
//        files = CoreDataManager.shared.fetchFiles()
    ...
    func filterFiles() {
        ...
        self.rowsToDisplay.sort(by: {dateFormatter.date(from: $0.timeStamp!)!  > dateFormatter.date(from: $1.timeStamp!)!})
        
        self.files.sort(by: {dateFormatter.date(from: $0.timeStamp!)!  > dateFormatter.date(from: $1.timeStamp!)!})
